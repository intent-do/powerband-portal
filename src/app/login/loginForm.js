        ...
        <Grid container sx={{ height: "100vh", overflow: "hidden" }}>
            ...
            >
                <img
                    ...
                    src="/images/dashboard/login2.png"
                    alt="Illustration"
                    style={{
                        // maxWidth: "80%", 
                        // borderRadius: 10, 
            ...
            >
                <img
                    ...
                    alt="Logo"
                />
                <Typography variant="h5" sx={{ mb: 3, mt: 3, fontWeight: 600, fontSize: "24px" }}>
                    Log In
                </Typography>
                <Box
                    component="form"
                ...
                >
                    <div style={{ marginBottom: "6px" }}>
                        <Typography variant="subtitle2" component="label" htmlFor="email" sx={{ fontSize: "14px", fontWeight: "600" }}>
                            Email
                        </Typography>
                    </div>
                    <TextField
                    ...
                    <div style={{ marginBottom: "6px" }}>
                        <Typography variant="subtitle2" component="label" htmlFor="password" sx={{ fontSize: "14px", fontWeight: "600" }}>
                            Password
                        </Typography>
                    </div>
                    <TextField
