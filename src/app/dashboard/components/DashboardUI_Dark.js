...
export default function DashboardUI_Dark(props) {
  ...
  const fetchDashboadData = async () => {
    try {
      ...
      // ]
      const dataChart = [
        { name: "Pass", value: props?.res?.passTasks, color: "#4CAF50" },
      ...
      >
        ...
        >
          ...
          <Box sx={{ flex: 3, pr: 3, color: "white", zIndex: 1 }}>
            ...
            >
              Welcome to Powerband Customer Portal
            ...
            >
              ...
              Your private space to oversee all of your jobs contracted to us.
            </Typography>
          </Box>
            ...
            <Grid item xs={12} md={6}>
              <Card
                sx={{
                  ...
                  background:
                    "linear-gradient(144deg, rgb(23, 23, 23) 0%, rgb(17, 17, 17) 99%)",
                }}
              >
                <Typography
                  style={{
                      ...
                      {dashboardData?.completionsJobs.length > 0 ? (
                        dashboardData?.completionsJobs?.map((job) => (
                          <TableRow key={job?.taskName}>
                            ...
                            <TableCell style={{ color: "#FFFFFF" }}>
                              {moment(job.completeddate).format("DD/MM/YYYY")}
                            </TableCell>
                            <TableCell>
                              <Chip
                                label={
                        ...
                        <TableRow>
                          <TableCell
                            colSpan={3}
                            style={{ textAlign: "center", padding: "89px" }}
                          >
                            <div
                              style={{
                                display: "flex",
                          ...
                          <TableRow key={job?.taskName}>
                            ...
                            <TableCell>
                              <Chip
                                label={job?.status}
                                style={{
                                  backgroundColor: getChipColor(job?.status)
                                    .bgcolor,
