...
const DocumentsTable_Dark = (props) => {
  // State for tabs
    ...
    <>
      <Box
        sx={{
          ...
          backgroundImage: "url('/images/documents/documents_card_new.png')",
                ...
                >
                  <TableCell colSpan={3}>
                    <Skeleton variant="rounded" width="100%" height={50}
                      sx={{
                        bgcolor: "#2c2c2c", // Darker skeleton base
                        '&::after': {
                          background: 'linear-gradient(90deg, transparent, rgba(255,255,255,0.1), transparent)', // Highlight shimmer
                        },
                      }} />
                    <br />
                    <Skeleton variant="rounded" width="100%" height={50}
                ...
                >
                  ...
                  {reportAndInvoiceDetails?.length > 0 ? (
                    ...
                    <TableRow>
                      ...
                      <TableCell colSpan={3} style={{ textAlign: "center", padding: "180px" }}>
...
export default DocumentsTable_Dark;
